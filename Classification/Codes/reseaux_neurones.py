...
for category in Classes:
    ...
    for img in Img_files:
        ...
        if(len(new_array) !=0):
            Ligne.append(new_array)
            Ligne.append(genre[0])
...
model.add(Dense(200, activation="relu", input_shape=input_shape )) #ajoute moi une couche de neurones (avec 100 neurones)
